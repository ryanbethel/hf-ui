...
<script type="module">
class HfMenuElement extends HTMLElement {
  #initialized = false;
  #boundClose;
...
export default class HfMenuElement extends HTMLElement {
  #initialized = false;
  #boundClose;
...
if (!customElements.get('hf-menu')) { 
  customElements.define("hf-menu", HfMenuElement) 
