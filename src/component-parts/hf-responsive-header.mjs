// hf-responsive-header Multiple Slots, dynamic state in Style (breakpoint only calculated for SSR), CSR has fixed breakpoint (layouts should generally be SSR).
...
export default function hfResponsiveHeader({ html, state }) {
...
<hf-h-rule></hf-h-rule>
<script type=module>
class HfResponsiveHeader extends HTMLElement {
  constructor() { super() }
}
...
export default class HfResponsiveHeader extends HTMLElement {
  constructor() {
    super();
